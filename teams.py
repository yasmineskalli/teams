...
roomArray[304] = "You walk towards the toilet, and notice a weird detachable contraption on the toilet. It says 'Bidet'? It looks like a teleporter, use it?. North is the table from the entrance, west is the oven. East and south are blocked off by walls."
